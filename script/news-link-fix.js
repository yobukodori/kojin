...
(function(){
	...
	function censor(art){
		if (art.src){
			art.ng = /スポーツ報知|スポーツアネックス|スポニチアネックス|東スポWeb|Smart FLASH|デイリースポーツ|日刊スポーツ|サーチナ|リアルライブ|Techinsight|スポーツソウル日本版|女性自身|ナリナリドットコム|オリコン|週刊女性|おくたま経済新聞/.test(art.src);
		}
		if (art.ng){
